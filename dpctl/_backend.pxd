...
cdef extern from "syclinterface/dpctl_sycl_queue_interface.h":
    ...
    cdef DPCTLSyclEventRef DPCTLQueue_Memset(
        ...
        int Val,
        size_t Count)
    cdef void DPCTLQueue_MemcpyEventless(
        const DPCTLSyclQueueRef Q,
        void *Dest,
        const void *Src,
        size_t Count)
    cdef void DPCTLQueue_MemsetEventless(
        const DPCTLSyclQueueRef Q,
        void *Dest,
        int Val,
        size_t Count)
    cdef void DPCTLQueue_PrefetchEventless(
        const DPCTLSyclQueueRef Q,
        const void *Src,
        size_t Count)
    ...
    cdef DPCTLSyclEventRef DPCTLQueue_GetLastEvent(
        const DPCTLSyclQueueRef QRef)
    cdef void DPCTLQueue_SetExternalEvent(
        const DPCTLSyclQueueRef QRef,
        const DPCTLSyclEventRef ERef)
